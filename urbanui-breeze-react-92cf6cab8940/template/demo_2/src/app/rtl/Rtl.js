      ...
      <div>
        <div className="page-header flex-wrap">
          ...
          <div className="d-flex">
            ...
            <button type="button" className="btn btn-sm bg-white text-black btn-icon-text border mr-3 ml-0">
          ...
          <div className="col-xl-8 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body px-4 px-xl-0  overflow-auto">
                ...
                <a className="text-white mt-3 d-block pr-4" href="!#" onClick={evt =>evt.preventDefault()}> <span className="font-weight-medium h6"><Trans>View all order history</Trans></span> <i className="mdi mdi-chevron-left"></i></a>
              </div>
            </div>
          </div>
          <div className="col-xl-4 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <a className="text-white mt-3 d-block font-weight-medium h6" href="!#" onClick={evt =>evt.preventDefault()}><Trans>View all</Trans> <i className="mdi mdi-chevron-left"></i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-xl-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <a className="text-white mt-3 mb-0 d-block h6" href="!#" onClick={evt =>evt.preventDefault()}><Trans>View all</Trans> <i className="mdi mdi-chevron-left"></i></a>
              </div>
            </div>
          </div>
        </div>

                ...
                <Dropdown.Menu className="preview-list navbar-dropdown navbar-dropdown-large">
                  ...
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center" href="!#" onClick={evt =>evt.preventDefault()}>
                    ...
                    <div className="preview-item-content">
                      <p className="mb-0 text-dark"><Trans>Dany Miles </Trans> <span className="text-small text-muted"><Trans>commented on your photo</Trans></span></p>
                    </div>
                  </Dropdown.Item>
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center" href="!#" onClick={evt =>evt.preventDefault()}>
                    <div className="preview-thumbnail">
                  ...
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center" href="!#" onClick={evt =>evt.preventDefault()}>
                    <div className="preview-thumbnail">
                      ...
                      <div className="preview-item-content">
                        <p className="mb-0 text-dark"><Trans>Alex </Trans> <span className="text-small text-muted"><Trans>just mentioned you in his post</Trans></span></p>
                    </div>
                  </Dropdown.Item>
                    <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center" href="!#" onClick={evt =>evt.preventDefault()}>

    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="text-center sidebar-brand-wrapper d-flex align-items-center">
          ...
          <a className="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src={require("../../assets/images/logo-mini.svg" )} alt="logo" /></a>
        </div>
        <ul className="nav">
          ...
          <a href="!#" onClick={evt =>evt.preventDefault()} className="nav-link">
              ...
              <div className="nav-profile-text d-flex align-items-center">
                <div className="pr-3">
                  <div className="font-weight-medium mb-2"><Trans>Henry Klein</Trans></div>
                  <div>$8,753.00</div>
                </div>
                <div>
                  <span className="badge badge-danger text-white rounded">3</span>
                </div>
              </div>
            </a>
          </li>
          ...
          <li className={ this.isPathActive('/rtl/Rtl') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
          ...
          <li className="nav-item">
            <span className="nav-link" href="#">
              <span className="menu-title text-white"><Trans>Docs</Trans></span>
            </span>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="http://bootstrapdash.com/demo/breeze/react/documentation/documentation.html" rel="noopener noreferrer" target="_blank">
              <i className="mdi mdi-file-document-box menu-icon text-white"></i>
              <span className="menu-title text-white"><Trans>Documentation</Trans></span>
            </a>
          </li>
            ...
            <div className="nav-link">
              <div className="mt-4">
                <div className="border-none">
                  <p className="text-white"><Trans>Notifications</Trans></p>
                </div>
                <ul className="mt-4 pl-0 pr-0">
                  <li><Trans>Sign Out</Trans></li>
                </ul>
              </div>
            </div>
          </li>

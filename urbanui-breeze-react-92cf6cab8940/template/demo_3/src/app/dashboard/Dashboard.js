          ...
          <div className="col-xl-8 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body px-4 px-xl-0  overflow-auto">
                ...
                <a className="text-black mt-3 d-block pl-4" href="!#" onClick={evt =>evt.preventDefault()}> <span className="font-weight-medium h6">View all order history</span> <i className="mdi mdi-chevron-right"></i></a>
              </div>
            </div>
          </div>
          <div className="col-xl-4 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <a className="text-black mt-3 d-block font-weight-medium h6" href="!#" onClick={evt =>evt.preventDefault()}>View all <i className="mdi mdi-chevron-right"></i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-xl-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <a className="text-black mt-3 mb-0 d-block h6" href="!#" onClick={evt =>evt.preventDefault()}>View all <i className="mdi mdi-chevron-right"></i></a>
              </div>
            </div>
          </div>
        </div>

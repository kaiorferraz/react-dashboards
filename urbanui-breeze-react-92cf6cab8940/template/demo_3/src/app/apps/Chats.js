                  ...
                  <div className="chat-container-wrapper">
                    ...
                    <div className="chat-bubble outgoing-chat">
                      <div className="chat-message">
                        <p className="font-weight-bold">Frank Carter</p>
                        <p>Leo duis ut diam quam nulla porttitor massa id neque. Sed enim ut sem</p>
                        <p className="font-weight-semibold"><i className="mdi mdi-paperclip mr-2"></i>workfile.pdf</p>
                      </div>
                      <div className="sender-details">
                        <img className="sender-avatar img-xs rounded-circle" src={require("../../assets/images/faces/face3.jpg")} alt="profile" />
                        <p className="seen-text">Message seen : 10 min ago</p>
                  ...
                  <div className="px-4">
                    <div className="d-flex pt-4">
                      <div className="wrapper">
                        <h5 className="font-weight-semibold mb-0 ellipsis">Cecelia Benson</h5>
                    ...
                    <div className="pt-3">
                      <div className="d-flex align-items-center py-1">
                        ...
                        <p className="mb-0 font-weight-semibold">225-248-4861</p>
                      </div>
                      <div className="d-flex align-items-center py-1">
                        <i className="mdi mdi-email-outline mr-2"></i>
                        <p className="mb-0 font-weight-semibold ellipsis">cecilia.tromp@danny.com</p>
                      </div>
                      <div className="d-flex align-items-center py-1">
                        <i className="mdi mdi-map-marker-outline mr-2"></i>
                        <p className="mb-0 font-weight-semibold ellipsis">United Kingdom</p>
                      </div>
                    </div>
                    <div className="list-item">
                      ...
                      <div className="wrapper pl-3">
                        <h5 className="font-weight-semibold mb-0">$2300</h5>
                    ...
                    <h5 className="font-weight-semibold mt-3">Documentation</h5>
                    <div className="list-item">
                      ...
                      <div className="wrapper pl-3 w-100">
                        <h5 className="font-weight-semibold mb-0 ellipsis">Company Profile.pdf</h5>
                        <div className="d-flex">
                    ...
                    <div className="list-item">
                      <div className="d-flex align-items-center justify-content-center img-sm badge-primary">
                        <i className="mdi mdi-file-pdf icon-sm"></i></div>
                      <div className="wrapper pl-3 w-100">
                        <h5 className="font-weight-semibold mb-0 ellipsis">Proposal.pdf</h5>
                        <div className="d-flex">
                    ...
                    <h5 className="font-weight-semibold mt-5 mb-4">Share photos</h5>
                    <div className="row">
                      <div className="col-4">

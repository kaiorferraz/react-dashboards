...
export class Dashboard extends Component {
  ...
  salesRevenueData = {
    ...
    datasets: [
        ...
        fill: true,
        lineTension: 0,
        backgroundColor: 'rgba(230, 246, 249, 0.06)'
      },
      {
        label: '# of Votes2',
        ...
        borderWidth: 1,
        fill: true,
        backgroundColor: 'rgba(230, 246, 249, 0.11)',
        lineTension: 0
      }
    ]
  };
  ...
  salesRevenueOptions = {
    ...
    scales: {
      ...
      xAxes: [{
        gridLines:{
          drawBorder: false,
          color: 'rgba(88, 88, 88, 0.36)',
          zeroLineColor: 'rgba(88, 88, 88, 0.36)',
        },
        ticks: {
          autoSkip: true,
          maxTicksLimit: 10
                ...
                <div className="card card-img">
                  <div className="card-body d-flex align-items-center">
                    <div className="text-white">
                      ...
                      <button className="btn bg-white text-black small">Get Premium</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body px-3 text-dark">
                    ...
                    <h5 className="font-weight-semibold text-white">Cosy Studio flat in London</h5>
                    <div className="d-flex justify-content-between font-weight-semibold text-muted">
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body px-3 text-dark">
                    ...
                    <h5 className="font-weight-semibold text-white">Victoria Bedsit Studio Ensuite</h5>
                    <div className="d-flex justify-content-between font-weight-semibold text-muted">
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body px-3 text-dark">
                    ...
                    <h5 className="font-weight-semibold text-white">Fabulous Huge Room </h5>
                    <div className="d-flex justify-content-between text-muted font-weight-semibold">
              ...
              <div className="col-xl-4 grid-margin">
                ...
                <div className="card stretch-card mb-3">
                  <div className="card-body d-flex flex-wrap justify-content-between">
                    <div>
                      <h4 className="font-weight-semibold mb-1 text-white">Member Profit</h4>
                ...
                <div className="card stretch-card mb-3">
                  <div className="card-body d-flex flex-wrap justify-content-between">
                    <div>
                      <h4 className="font-weight-semibold mb-1 text-white">Total Profit</h4>
                ...
                <div className="card mt-3">
                  <div className="card-body d-flex flex-wrap justify-content-between">
                    <div>
                      <h4 className="font-weight-semibold mb-1 text-white">Issue Reports</h4>
              ...
              <div className="col-xl-8 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body p-0">
                    ...
                    <a className="text-white font-13 d-block pt-2 pb-2 pb-lg-0 font-weight-bold pl-4" href="!#" onClick={evt => evt.preventDefault()}>Show more</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex border-bottom border-top py-3">
                      ...
                      <div className="pl-2">
                        ...
                        <p className="m-0 text-white">Hey I attached some new PSD files…</p>
                      </div>
                    </div>
                    <div className="d-flex border-bottom py-3">
                      ...
                      <div className="pl-2">
                        ...
                        <p className="m-0 text-white">Discuss performance with manager</p>
                      </div>
                    </div>
                    <div className="d-flex border-bottom py-3">
                      <div className="form-check">
                      ...
                      <div className="pl-2">
                        <span className="small text-muted">Tue, Mar 5, 9.30am</span>
                        <p className="m-0 text-white">Meeting with Alisa </p>
                      </div>
                    </div>

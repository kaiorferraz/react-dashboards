        ...
        <nav className="navbar top-navbar default-layout-navbar col-lg-12 col-12 p-0 d-flex flex-row">
          <div className="container">
            <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <Link className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/logo.svg')} alt="logo" /><span
                className="font-12 d-none d-lg-block text-left text-muted font-weight-light">Responsive Dashboard</span></Link>
                  ...
                  <Dropdown alignRight>
                    <Dropdown.Toggle className="nav-link">
                      ...
                      <div className="nav-profile-text">
                        <p className="mb-0 font-weight-semibold"><Trans>Olson jass</Trans></p>
                        <span className="d-block font-13 text-muted text-left font-weight-normal">
                        <Trans>online</Trans>
        ...
        <nav className="bottom-navbar">
          <div className="container">
            <ul className="nav page-navigation">
              ...
              <li className="nav-item">
                <div className="nav-link">
                  <button className="btn btn-sm btn-danger"><Trans>Trailing</Trans></button>
                  <i className="mdi mdi-home-circle font-20 ml-3"></i></div>
              </li>     
            </ul>
          </div>
        </nav>

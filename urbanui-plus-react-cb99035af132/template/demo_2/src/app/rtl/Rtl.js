                ...
                <div className="card card-img">
                  <div className="card-body d-flex align-items-center">
                    <div className="text-white">
                      ...
                      <button className="btn bg-white text-black small"><Trans>Get Premium</Trans></button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body px-3 text-muted">
                    <div className="d-flex justify-content-between">
                      <p className="text-muted font-13 mb-0"><Trans>ENTIRE APARTMENT</Trans></p>
                      <i className="mdi mdi-heart-outline"></i>
                    </div>
                    <h5 className="font-weight-semibold text-white"><Trans>Cosy Studio flat in London</Trans></h5>
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body px-3 text-muted">
                    ...
                    <h5 className="font-weight-semibold text-white"><Trans>Victoria Bedsit Studio Ensuite</Trans></h5>
                    <div className="d-flex justify-content-between font-weight-semibold">
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body px-3 text-muted">
                    ...
                    <h5 className="font-weight-semibold text-white"><Trans>Fabulous Huge Room</Trans> </h5>
                    <div className="d-flex justify-content-between font-weight-semibold">
              ...
              <div className="col-xl-4 grid-margin">
                ...
                <div className="card stretch-card mb-3">
                  <div className="card-body d-flex flex-wrap justify-content-between">
                    <div>
                      <h4 className="font-weight-semibold mb-1 text-white"><Trans>Member Profit</Trans></h4>
                ...
                <div className="card stretch-card mb-3">
                  <div className="card-body d-flex flex-wrap justify-content-between">
                    <div>
                      <h4 className="font-weight-semibold mb-1 text-white"><Trans>Total Profit</Trans></h4>
                ...
                <div className="card mt-3">
                  <div className="card-body d-flex flex-wrap justify-content-between">
                    <div>
                      <h4 className="font-weight-semibold mb-1 text-white"><Trans>Issue Reports</Trans></h4>
              ...
              <div className="col-xl-8 stretch-card grid-margin">
                <div className="card">
                  ...
                  <div className="card-body p-0">
                    ...
                    <a className="text-white font-13 d-block pt-2 pb-2 pb-lg-0 font-weight-bold pr-4" href="!#" onClick={evt => evt.preventDefault()}><Trans>Show more</Trans></a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex border-bottom border-top py-3">
                      ...
                      <div className="pr-2">
                        ...
                        <p className="m-0 text-white"><Trans>Hey I attached some new PSD files…</Trans></p>
                      </div>
                    </div>
                    <div className="d-flex border-bottom py-3">
                      ...
                      <div className="pr-2">
                        ...
                        <p className="m-0 text-white"><Trans>Discuss performance with manager</Trans></p>
                      </div>
                    </div>
                    <div className="d-flex border-bottom py-3">
                      <div className="form-check">
                      ...
                      <div className="pr-2">
                        <span className="small text-muted"><Trans>Tue, Mar 5, 9.30am</Trans></span>
                        <p className="m-0 text-white"><Trans>Meeting with Alisa</Trans> </p>
                      </div>
                    </div>

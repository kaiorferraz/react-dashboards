    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          <li className="nav-item nav-profile border-bottom">
            <a href="!#" className="nav-link flex-column" onClick={evt =>evt.preventDefault()}>
              ...
              <div className="nav-profile-text ml-0 mb-3 text-center">
                <span className="font-weight-semibold mb-1 mt-2 font-14"><Trans>Antonio Olson</Trans></span>
                <span className="text-secondary font-16"><Trans>$3499.00</Trans></span>
              </div>
            </a>
          </li>
          <li className="nav-item sidebar-brand-wrapper">
            <Link to="/dashboard" className="nav-link sidebar-logo flex-column align-items-baseline">
              <img src={ require("../../assets/images/logo.svg") } alt="logo"/>
              <span className="small font-weight-light pt-1"><Trans>Responsive Dashboard</Trans></span>
            </Link>
            <Link to="/dashboard" className="nav-link sidebar-logo-mini">
              <img src={ require("../../assets/images/logo-mini.svg") } alt="logo"/>
            </Link>
            <form action="!#" className="search-form" onSubmit={evt=>evt.preventDefault()}>
              <div className="input-group">
                <div className="input-group-prepend">
                  <i className="input-group-text border-0 mdi mdi-magnify"></i>
                </div>
                <input type="text" className="form-control border-0 pl-0" placeholder="Search" />
              </div>
            </form>
          </li>
          <li className="nav-item nav-category">
            <span>
              <Trans>Template Pages</Trans>
            </span>
          </li>
          ...
          <li className={ this.isPathActive('/widgets') ? 'nav-item active pb-3 border-bottom' : 'nav-item pb-3 border-bottom' }>
          ...
          <li className="nav-item nav-category">
            <span><Trans>UI Elements</Trans></span>
          </li>
          ...
          <li className={ this.isPathActive('/ecommerce') ? 'nav-item active pb-3 border-bottom' : 'nav-item pb-3 border-bottom' }>
          ...
          <li className="nav-item">
            <a className="nav-link" href="http://bootstrapdash.com/demo/plus/react/documentation/documentation.html" rel="noopener noreferrer" target="_blank">

                ...
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-semibold text-right mb-0 text-dark">$6,560</h3>
                    </div>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-semibold text-right mb-0 text-dark">3455</h3>
                    </div>
                  </div>
                </div>
                <p className="text-muted mt-3 mb-0">
              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-semibold text-right mb-0 text-dark">5693</h3>
                    </div>
                  </div>
                </div>
                <p className="text-muted mt-3 mb-0">
              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-semibold text-right mb-0 text-dark">246</h3>
                    </div>
                  </div>
                </div>
                <p className="text-muted mt-3 mb-0">
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        ...
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-semibold text-dark">65,650</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        ...
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-semibold text-dark">32,604</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        ...
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-semibold text-dark">17,583</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        ...
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-semibold text-dark">61,119</h3>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-7">
                    <h4 className="card-title font-weight-semibold mb-0 d-none d-md-block">Active Users</h4>
                    <div className="wrapper mt-4">
                      <div className="d-flex justify-content-between mb-2">
                        <div className="d-flex align-items-center">
                          <p className="mb-0 font-weight-semibold">67,550</p>
                          <small className="text-muted ml-2">Email account</small>
                        </div>
                        <p className="mb-0 font-weight-semibold">80%</p>
                      </div>
                    ...
                    <div className="wrapper mt-4">
                      <div className="d-flex justify-content-between mb-2">
                        <div className="d-flex align-items-center">
                          <p className="mb-0 font-weight-semibold">21,435</p>
                          <small className="text-muted ml-2">Requests</small>
                        </div>
                        <p className="mb-0 font-weight-semibold">34%</p>
                      </div>
          ...
          <div className="col-sm-6 col-md-6 col-lg-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div className="row">
                  <div className="col-md-7">
                    <h4 className="card-title font-weight-semibold mb-3">Amount Due</h4>
                    <h1 className="font-weight-semibold mb-0 text-dark">$5998</h1>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <div className="d-flex align-items-center">
                  <h1 className="font-weight-semibold mb-2 text-dark">$2,156</h1>
                  <h5 className="font-weight-semibold text-success ml-2">−14.2%</h5>
                </div>
                <div className="d-flex align-items-center">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <div className="d-flex align-items-center">
                  <h1 className="font-weight-semibold mb-2 text-dark">$1,520</h1>
                  <h5 className="font-weight-semibold text-success ml-2">+20.7%</h5>
                </div>
                <div className="d-flex align-items-center">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <div className="d-flex align-items-center">
                  <h1 className="font-weight-semibold mb-2 text-dark">$6.60</h1>
                  <h5 className="font-weight-semibold text-success ml-2">+296.6%</h5>
                </div>
                <div className="d-flex align-items-center">

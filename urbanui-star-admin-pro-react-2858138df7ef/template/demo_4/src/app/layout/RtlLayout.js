      ...
      <div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="wrapper mt-4 d-none d-lg-block">
                      <p class="text-muted mb-0">Note: These statistics are aggregates over all of your application's users. </p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="row">
          <div class="col-md-6 col-lg-5 grid-margin stretch-card top-selling-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title mb-4">Total selling product</h4>
          ...
          <div class="col-md-6 col-lg-7 grid-margin stretch-card top-selling-card">
            ...
            <div class="card">
              <div class="card-header header-sm">
                <div class="d-flex align-items-center">
                  ...
                  <div class="wrapper mr-auto action-bar">
                    <Dropdown alignRight>
                    ...
                    >
                      {
                        props => (
                          <div>
                            <div className="d-flex align-items-center">
                              <p className="mb-2 ml-2">Search in table:</p>

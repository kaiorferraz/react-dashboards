                    ...
                    <Dropdown.Menu className="preview-list navbar-dropdown">
                      ...
                      <Dropdown.Item className="dropdown-item d-flex align-items-center preview-item">
                        <div class="preview-thumbnail">
                          <img src={require("../../assets/images/faces/face10.jpg")} alt="notification1" class="img-sm profile-pic"/> </div>
                      ...
                      <Dropdown.Item className="dropdown-item d-flex align-items-center preview-item">
                        <div class="preview-thumbnail">
                          <img src={require("../../assets/images/faces/face12.jpg")} alt="notification2" class="img-sm profile-pic"/> </div>
                        <div class="preview-item-content flex-grow py-2">
                      ...
                      <Dropdown.Item className="dropdown-item d-flex align-items-center preview-item">
                        <div class="preview-thumbnail">
                          <img src={require("../../assets/images/faces/face1.jpg")} alt="notification3" class="img-sm profile-pic"/> </div>
                        <div class="preview-item-content flex-grow py-2">
                  ...
                  <Dropdown alignRight>
                    <Dropdown.Toggle className="nav-link count-indicator">
                      <div class="wrapper d-flex flex-column">
                        <span class="profile-text">Adam Smith</span>
                    ...
                    <Dropdown.Menu className="preview-list navbar-dropdown">
                      <Dropdown.Item className="dropdown-item d-flex align-items-center">
                        <div class="dropdown-header text-center">
                          <img class="img-md rounded-circle" src={require("../../assets/images/faces/face1.jpg")} alt="Profile"/>
                      ...
                      <div className="dropdown-divider"></div>
                      <Dropdown.Item className="dropdown-item d-flex align-items-center">
                        <i class="dropdown-item-icon mdi mdi-account-outline text-primary"></i> My Profile 
                        <span class="badge badge-pill badge-danger">1</span>
                      </Dropdown.Item>
                      <div className="dropdown-divider"></div>
                      <Dropdown.Item className="dropdown-item d-flex align-items-center">
                        <i class="dropdown-item-icon mdi mdi-message-text-outline text-primary"></i> Messages
                      </Dropdown.Item>
                      <Dropdown.Item className="dropdown-item d-flex align-items-center">
                        <i class="dropdown-item-icon mdi mdi-calendar-check-outline text-primary"></i> Activity
                      </Dropdown.Item>
                      <Dropdown.Item className="dropdown-item d-flex align-items-center">
                        <i class="dropdown-item-icon mdi mdi-help-circle-outline text-primary"></i> FAQ
                      </Dropdown.Item>
                      <Dropdown.Item className="dropdown-item d-flex align-items-center">
                        <i class="dropdown-item-icon mdi mdi-power text-primary"></i>Sign Out
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </li>
          ...
          <div className="container">
            <ul className="nav page-navigation">
              ...
              <li className={ this.isPathActive('/basic-ui') ? 'nav-item mega-menu active' : this.isPathActive('/advanced-ui') ? 'nav-item mega-menu active' : this.isPathActive('/icons') ? 'nav-item mega-menu active' : 'nav-item mega-menu' }>
                <div href="!#" onClick={evt =>evt.preventDefault()} className="nav-link">
              ...
              <li className={ this.isPathActive('/form-elements') ? 'nav-item active' : this.isPathActive('/text-editors') ? 'nav-item active' : this.isPathActive('/code-editor') ? 'nav-item active' :  'nav-item' }>
                ...
                <div className="submenu">
                  ...
                  <li className="nav-item"> <Link className={ this.isPathActive('/text-editors') ? 'nav-link active' : 'nav-link' } to="/text-editors"><Trans>Text Editors</Trans></Link></li>
                  <li className="nav-item"> <Link className={ this.isPathActive('/code-editor') ? 'nav-link active' : 'nav-link' } to="/code-editor"><Trans>Code Editors</Trans></Link></li>
                  </ul>
                </div>
              </li>
              ...
              <li className="nav-item">
                <a className="nav-link" href="https://www.bootstrapdash.com/demo/star-admin-pro-react/documentation/documentation.html" rel="noopener noreferrer" target="_blank">
                  <i className="mdi mdi-file-document-box menu-icon"></i>
                  <span className="menu-title"><Trans>Documentation</Trans></span></a>
              </li>     
            </ul>
          </div>
        </nav>

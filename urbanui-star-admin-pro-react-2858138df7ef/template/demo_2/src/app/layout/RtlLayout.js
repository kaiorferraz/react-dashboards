          ...
          <div className="col-12">
            <div className="page-header">
              ...
              <div className="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
                ...
                <ul className="quick-links mr-auto">
                  ...
                  <div className="data-wrapper d-flex mt-2 mt-lg-0">
                    <div className="wrapper pl-5">
                      ...
                      <div className="d-xl-flex align-items-center">
                        ...
                        <small className="mr-2 text-gray d-none d-lg-block"><b>89.5%</b> of 20,000 Total</small>
                      </div>
                    </div>
                    <div className="wrapper">
                      ...
                      <div className="d-xl-flex align-items-center">
                        ...
                        <small className="mr-2 text-gray d-none d-lg-block"><b>10.5%</b> of 20,000 Total</small>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="d-flex mt-3 py-2 border-bottom">
                      ...
                      <small className="text-muted mr-auto">1 Hours ago</small>
                    </div>
                    <div className="d-flex py-2 border-bottom">
                      ...
                      <small className="text-muted mr-auto">4 Hours ago</small>
                    </div>
                    <div className="d-flex py-2 border-bottom">
                    ...
                    <div className="d-flex pt-2">
                      ...
                      <small className="text-muted mr-auto">7 Hours ago</small>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="d-flex py-2 border-bottom">
                  ...
                  <small className="text-muted mr-auto">Edit event</small>
                </div>
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    <small className="text-muted">Mar 14, 2019</small>

      ...
      <div>
        <div className="row page-title-header">
          <div className="col-12">
            <div className="page-header">
              <h4 className="page-title"><Trans>Dashboard</Trans></h4>
              <div className="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
                <ul className="quick-links">
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>ICE Market data</Trans></a></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>Own analysis</Trans></a></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>Historic market data</Trans></a></li>
                </ul>
                <ul className="quick-links ml-auto">
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>Settings</Trans></a></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>Analytics</Trans></a></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>Watchlist</Trans></a></li>
                </ul>
              </div>
            </div>
          </div>
          <div className="col-md-12">
            <div className="page-header-toolbar">
              <div className="btn-group toolbar-item" role="group" aria-label="Basic example">
                <button type="button" className="btn btn-inverse-primary"><i className="mdi mdi-chevron-left"></i></button>
                <button type="button" className="btn btn-inverse-primary">03/02/2019 - 20/08/2019</button>
                <button type="button" className="btn btn-inverse-primary"><i className="mdi mdi-chevron-right"></i></button>
              </div>
              <div className="filter-wrapper">
                <div className="dropdown toolbar-item">
                  <Dropdown>
                    <Dropdown.Toggle variant="btn btn-inverse-primary dropdown-toggle" id="dropdownMenuButton1">
                    <Trans>All Day</Trans>
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
                      <Dropdown.Header><Trans>Last Day</Trans></Dropdown.Header>
                      <Dropdown.Item><Trans>Last Month</Trans></Dropdown.Item>
                      <Dropdown.Item><Trans>Last Year</Trans></Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </div>
              ...
              <button type="button" className="btn btn-inverse-primary">New</button>
                <Dropdown>
                  <Dropdown.Toggle variant="btn btn-inverse-primary dropdown-toggle  toolbar-item" id="dropdownMenuButton2">
                  <Trans>Export</Trans>
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
                    <Dropdown.Header><Trans>Export as PDF</Trans></Dropdown.Header>
                    <Dropdown.Item><Trans>Export as DOCX</Trans></Dropdown.Item>
                    <Dropdown.Item><Trans>Export as CDR</Trans></Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </div>
            </div>
                  ...
                  <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      <div className="wrapper">
                        <h3 className="mb-0 font-weight-semibold"><Trans>32,451</Trans></h3>
                        <h5 className="mb-0 font-weight-medium text-primary"><Trans>Visits</Trans></h5>
                        <p className="mb-0 text-muted">+14.00(+0.50%)</p>
                      </div>
                      <div className="wrapper my-auto mr-auto mr-lg-4">
                  ...
                  <div className="col-xl-3 col-lg-6 col-sm-6 mt-md-0 mt-4 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      <div className="wrapper">
                        ...
                        <h5 className="mb-0 font-weight-medium text-primary"><Trans>Impressions</Trans></h5>
                  ...
                  <div className="col-xl-3 col-lg-6 col-sm-6 mt-md-0 mt-4 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      <div className="wrapper">
                        ...
                        <h5 className="mb-0 font-weight-medium text-primary"><Trans>Conversion</Trans></h5>
                  ...
                  <div className="col-xl-3 col-lg-6 col-sm-6 mt-md-0 mt-4 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      <div className="wrapper">
                        ...
                        <h5 className="mb-0 font-weight-medium text-primary"><Trans>Downloads</Trans></h5>
                        <p className="mb-0 text-muted">+138.97(+0.54%)</p>
                      </div>
                      <div className="wrapper my-auto mr-auto mr-lg-4">
        ...
        <div className="row">
          <div className="col-md-8 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title mb-0"><Trans>Sales Statistics Overview</Trans></h4>
                <div className="d-xl-flex flex-column flex-lg-row">
                  <p><Trans>Lorem ipsum is placeholder text commonly used</Trans></p>
                  <ul className="nav nav-tabs sales-mini-tabs mr-lg-auto mb-4 mb-md-0" role="tablist">
                    <li className="nav-item">
                      <button className={`nav-link bg-dark ${this.state.active === "sales-statistics_switch_1"? 'active': ''}`} id="sales-statistics_switch_1" onClick={this.changeChartOneData} data-toggle="tab" role="tab" aria-selected="false">1D</button>
                    </li>
                    <li className="nav-item">
                      <button className={`nav-link bg-dark ${this.state.active === "sales-statistics_switch_2"? 'active': ''}`} id="sales-statistics_switch_2" onClick={this.changeChartTwoData} data-toggle="tab" role="tab" aria-selected="false">5D</button>
                    </li>
                    <li className="nav-item">
                      <button className={`nav-link bg-dark ${this.state.active === "sales-statistics_switch_3"? 'active': ''}`} id="sales-statistics_switch_3" onClick={this.changeChartThreeData} data-toggle="tab" role="tab" aria-selected="false">1M</button>
                    </li>
                    <li className="nav-item">
                      <button className={`nav-link bg-dark ${this.state.active === "sales-statistics_switch_4"? 'active': ''}`} id="sales-statistics_switch_4" onClick={this.changeChartFourData} data-toggle="tab" role="tab" aria-selected="false">1Y</button>
                    </li>
                  </ul>
                </div>
                <div className="d-xl-flex flex-column flex-lg-row">
                  <div className="data-wrapper d-flex mt-2 mt-lg-0">
                    <div className="wrapper pl-5">
                      <h5 className="mb-0"><Trans>Total Cost</Trans></h5>
                    ...
                    <div className="wrapper">
                      <h5 className="mb-0"><Trans>Total Revenue</Trans></h5>
                      <div className="d-xl-flex align-items-center">
                  ...
                  <div className="chartjs-legend line-legend">
                    <ul>
                      <li>
                        <span className="bg-info"></span><Trans>Revenue</Trans>
                      </li>
                      <li>
                        <span className="bg-success"></span><Trans>Sales</Trans>
                      </li>
                    </ul>
                  </div>
                  </div>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body d-flex flex-column">
                <div className="wrapper">
                  <h4 className="card-title mb-0"><Trans>Net Profit Margin</Trans></h4>
                  <p><Trans>Started collecting data from February 2019</Trans></p>
                  ...
                  <ul>
                    ...
                    <li>
                      <span className="bg-info"></span><Trans>Orders</Trans>
                    </li>
                  </ul>
                  </div>
                </div>
            ...
            <div className="row">
                ...
                <div className="card">
                  <div className="card-body pb-0">
                    <div className="d-flex justify-content-between">
                      <h4 className="card-title mb-0"><Trans>Total Revenue</Trans></h4>
              ...
              <div className="col-xl-6 col-lg-12 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body pb-0">
                    <div className="d-flex justify-content-between">
                      <h4 className="card-title mb-0"><Trans>Transaction</Trans></h4>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-0"><Trans>Market Overview</Trans></h4>
                    <div className="d-flex align-items-center justify-content-between w-100">
                      <p className="mb-0"><Trans>Lorem ipsum dolor sit amet consectetur adipisicing elit.</Trans></p>
                      <div className="dropdown">
                        <Dropdown>
                          <Dropdown.Toggle variant="btn btn-inverse-primary dropdown-toggle" id="dropdownMenuButton4">
                          <Trans>Daily</Trans>
                          </Dropdown.Toggle>
                          <Dropdown.Menu>
                            <Dropdown.Item  onClick={this.changeMarketingOneData} ><Trans>Daily</Trans></Dropdown.Item>
                            <Dropdown.Item  onClick={this.changeMarketingTwoData}><Trans>Weekly</Trans></Dropdown.Item>
                            <Dropdown.Item onClick={this.changeMarketingThreeData}><Trans>Monthly</Trans></Dropdown.Item>
                          </Dropdown.Menu>
                        </Dropdown>
                      </div>
                    </div>
                    <div className="d-flex align-items-end">
                      ...
                      <p className="mb-0 font-weight-medium mr-2 ml-2 mb-1"><Trans>USD</Trans></p>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex justify-content-between">
                      <h4 className="card-title mb-0"><Trans>Invoice</Trans></h4>
                      <a href="!#" onClick={evt =>evt.preventDefault()}><small><Trans>Show All</Trans></small></a>
                    </div>
                    <p><Trans>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est quod cupiditate esse fuga</Trans></p>
                    <div className="table-responsive">
                      <table className="table table-striped table-hover">
                        <thead>
                          <tr>
                            <th><Trans>Invoice ID</Trans></th>
                        ...
                        <tbody>
                          <tr>
                            <td><Trans>INV-87239</Trans></td>
                            <td><Trans>Viola Ford</Trans></td>
                            <td><Trans>Paid</Trans></td>
                            <td><Trans>20 Jan 2019</Trans></td>
                            <td><Trans>$755</Trans></td>
                          </tr>
                          <tr>
                            <td><Trans>INV-87239</Trans></td>
                            <td><Trans>Dylan Waters</Trans></td>
                            <td><Trans>Unpaid</Trans></td>
                            <td><Trans>23 Feb 2019</Trans></td>
                            <td><Trans>$800</Trans></td>
                          </tr>
                          <tr>
                            <td><Trans>INV-87239</Trans></td>
                            <td><Trans>Louis Poole</Trans></td>
                            <td><Trans>Unpaid</Trans></td>
                            <td><Trans>25 Mar 2019</Trans></td>
                            <td><Trans>$463</Trans></td>
                          </tr>
                          <tr>
                            <td><Trans>INV-87239</Trans></td>
                            <td><Trans>Vera Howell</Trans></td>
                            <td><Trans>Paid</Trans></td>
                            <td><Trans>27 Mar 2019</Trans></td>
                            <td><Trans>$235</Trans></td>
                          </tr>
                          <tr>
                            <td><Trans>INV-87239</Trans></td>
                            <td><Trans>Allie Goodman</Trans></td>
                            <td><Trans>Unpaid</Trans></td>
                            <td><Trans>1 Apr 2019</Trans></td>
                            <td><Trans>$657</Trans></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="d-flex align-items-center pb-2">
                          <div className="dot-indicator bg-danger ml-2"></div>
                          <p className="mb-0"><Trans>Total Sales</Trans></p>
                        </div>
                      ...
                      <div className="col-md-6 mt-4 mt-md-0">
                        <div className="d-flex align-items-center pb-2">
                          <div className="dot-indicator bg-success ml-2"></div>
                          <p className="mb-0"><Trans>Active Users</Trans></p>
                        </div>
              ...
              <div className="col-md-6 grid-margin stretch-card average-price-card">
                <div className="card text-white">
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between">
                      <h5 className="font-weight-semibold mb-0"><Trans>Average Price</Trans></h5>
                      <p className="text-white mb-0"><Trans>Since last month</Trans></p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-4">
            <div className="row">
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h1 className="card-title mb-4"><Trans>Website Audience Metrics</Trans></h1>
                    <div className="row">
                      <div className="col-xl-5 col-lg-12">
                        <div className="wrapper border-bottom mb-2 pb-2">
                          <h4 className="font-weight-semibold mb-0">523,200</h4>
                          <div className="d-flex align-items-center">
                            <p className="mb-0"><Trans>Page Views</Trans></p>
                            <div className="dot-indicator bg-secondary mr-auto"></div>
                          </div>
                        </div>
                        <div className="wrapper mb-2 mb-lg-0">
                          <h4 className="font-weight-semibold mb-0">753,098</h4>
                          <div className="d-flex align-items-center">
                            <p className="mb-0"><Trans>Bounce Rate</Trans></p>
                            <div className="dot-indicator bg-primary mr-auto"></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-xl-7 col-lg-12 pl-4">
                    ...
                    <div className="row mt-5">
                      <div className="col-xl-5 col-lg-12">
                        <div className="d-flex align-items-center mb-2">
                          <div className="icon-holder bg-primary text-white py-1 px-3 rounded ml-2">
                            <i className="mdi mdi-buffer icon-sm"></i>
                          </div>
                          <h2 className="font-weight-semibold mb-0">3,605</h2>
                        </div>
                        <p><Trans>Since last week</Trans></p>
                        <p className="mb-3 mb-lg-0"><span className="font-weight-medium">0.51%</span> (30 <Trans>days</Trans>)</p>
                      </div>
                      <div className="col-xl-7 col-lg-12">
                        <div className="mt-n3 ml-auto" id="dashboard-guage-chart"></div>
                        <GaugeChart id="gauge-chart1" textColor="#fff" percent={0.65} arcPadding={0} cornerRadius={0} nrOfLevels={2} colors={["#FF0017", "#eceaea"]} arcsLength={[0.4, 0.25]}  />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-4"><Trans>World sellings</Trans></h4>
                    ...
                    <div className="wrapper">
                      <div className="d-flex w-100 pt-2 mt-4">
                        <p className="mb-0 font-weight-semibold"><Trans>California</Trans></p>
                        <div className="wrapper ml-auto d-flex align-items-center">
                          <p className="font-weight-semibold mb-0">26,437</p>
                          <p className="mr-1 mb-0">26%</p>
                        </div>
                      </div>
                      <div className="d-flex w-100 pt-2">
                        <p className="mb-0 font-weight-semibold"><Trans>Washington</Trans></p>
                        <div className="wrapper ml-auto d-flex align-items-center">
                          <p className="font-weight-semibold mb-0">3252</p>
                          <p className="mr-1 mb-0">64%</p>
                        </div>
                      </div>
                      <div className="d-flex w-100 pt-2">
                        <p className="mb-0 font-weight-semibold"><Trans>Michigan</Trans></p>
                        <div className="wrapper ml-auto d-flex align-items-center">
                          <p className="font-weight-semibold mb-0">4,987</p>
                          <p className="mr-1 mb-0">30%</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title mb-0"><Trans>Top Performer</Trans></h4>
                    <div className="d-flex mt-3 py-2 border-bottom">
                      ...
                      <div className="wrapper mr-2 ml-2">
                        <p className="mb-n1 font-weight-semibold"><Trans>Ray Douglas</Trans></p>
                        <small>162543</small>
                      </div>
                      <small className="text-muted mr-auto"><Trans>1 Hours ago</Trans></small>
                    </div>
                    <div className="d-flex py-2 border-bottom">
                      <span className="img-sm rounded-circle bg-warning text-white text-avatar"><Trans>OH</Trans></span>
                      <div className="wrapper mr-2 ml-2">
                        <p className="mb-n1 font-weight-semibold"><Trans>Ora Hill</Trans></p>
                        <small>162543</small>
                      </div>
                      <small className="text-muted mr-auto">4 <Trans>Hours ago</Trans></small>
                    </div>
                    <div className="d-flex py-2 border-bottom">
                      <img className="img-sm rounded-circle" src={require("../../assets/images/faces/face4.jpg")} alt="profile" />
                      <div className="wrapper mr-2 ml-2">
                        <p className="mb-n1 font-weight-semibold"><Trans>Brian Dean</Trans></p>
                        <small>162543</small>
                      </div>
                      <small className="text-muted mr-auto">4 <Trans>Hours ago</Trans></small>
                    </div>
                    <div className="d-flex pt-2">
                      <span className="img-sm rounded-circle bg-success text-white text-avatar"><Trans>OB</Trans></span>
                      <div className="wrapper mr-2 ml-2">
                        <p className="mb-n1 font-weight-semibold"><Trans>Olive Bridges</Trans></p>
                        <small>162543</small>
                      </div>
                      <small className="text-muted mr-auto">7 <Trans>Hours ago</Trans></small>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="row">
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title mb-0"><Trans>Recent Events</Trans></h4>
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    <small className="text-muted"><Trans>Mar 14, 2019</Trans></small>
                    <p className="font-weight-semibold text-light mb-0"><Trans>Change in Directors</Trans></p>
                  </div>
                  <small className="text-muted ml-auto"><Trans>Edit event</Trans></small>
                </div>
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    <small className="text-muted"><Trans>Mar 14, 2019</Trans></small>
                    <p className="font-weight-semibold text-light mb-0"><Trans>Other Events</Trans></p>
                  </div>
                  <small className="text-muted ml-auto"><Trans>Edit event</Trans></small>
                </div>
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    <small className="text-muted"><Trans>Mar 14, 2019</Trans></small>
                    <p className="font-weight-semibold text-light mb-0"><Trans>Quarterly Report</Trans></p>
                  </div>
                  <small className="text-muted ml-auto"><Trans>Edit event</Trans></small>
                </div>
                <div className="d-flex pt-2">
                ...
                <a className="d-block mt-5" href="!#" onClick={evt =>evt.preventDefault()}><Trans>Show all</Trans></a>
              </div>
            </div>
          </div>
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div className="d-flex justify-content-between pb-3">
                  <h4 className="card-title mb-0"><Trans>Activities</Trans></h4>
                  <p className="mb-0 text-muted"><Trans>20 finished, 5 remaining</Trans></p>
                </div>
                <ul className="timeline">
                  <li className="timeline-item">
                    <p className="timeline-content"><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>Ben Tossell</Trans></a> <Trans>assign you a task</Trans></p>
                    <p className="event-time"><Trans>Just now</Trans></p>
                  </li>
                  <li className="timeline-item">
                    <p className="timeline-content"><a href="!#" onClick={evt =>evt.preventDefault()}><Trans>Ben Tossell</Trans></a> <Trans>assign you a task</Trans></p>
                    <p className="event-time"><Trans>Just now</Trans></p>
                ...
                <a className="d-block mt-3" href="!#" onClick={evt =>evt.preventDefault()}><Trans>Show all</Trans></a>
              </div>
            </div>
          </div>
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title mb-0"><Trans>People Also Watch</Trans></h4>
                <div className="table-responsive">
                  <table className="table table-stretched">
                    <thead>
                      <tr>
                        <th><Trans>Symbol</Trans></th>
                        <th><Trans>Last Price</Trans></th>
                        <th><Trans>Change</Trans></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td>
                          <p className="mb-1 font-weight-medium"><Trans>NFLX</Trans></p><small className="font-weight-medium"><Trans>Netflix, Inc.</Trans></small>
                        </td>
                      ...
                      <tr>
                        <td>
                          <p className="mb-1 font-weight-medium"><Trans>TSLA</Trans></p><small className="font-weight-medium"><Trans>Tesla, Inc.</Trans></small>
                        </td>
                      ...
                      <tr>
                        <td>
                          <p className="mb-1 font-weight-medium">GOOG</p><small className="font-weight-medium">Alphabet, Inc.</small>
                        </td>
                        <td className="font-weight-medium">$250.00</td>
                      ...
                      <tr>
                        <td>
                          <p className="mb-1 font-weight-medium"><Trans>AMZN</Trans></p><small className="font-weight-medium"><Trans>Amazon.com, Inc.</Trans></small>
                        </td>

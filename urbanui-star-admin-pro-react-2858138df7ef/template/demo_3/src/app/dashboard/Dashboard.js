              ...
              <div className="card-body">
                ...
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    ...
                    <p className="font-weight-semibold text-light mb-0">Change in Directors</p>
                  </div>
                ...
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    <small className="text-muted">Mar 14, 2019</small>
                    <p className="font-weight-semibold text-light mb-0">Other Events</p>
                  </div>
                  <small className="text-muted ml-auto">Edit event</small>
                </div>
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    <small className="text-muted">Mar 14, 2019</small>
                    <p className="font-weight-semibold text-light mb-0">Quarterly Report</p>
                  </div>
                  <small className="text-muted ml-auto">Edit event</small>
                </div>
                <div className="d-flex pt-2">
                ...
                <div className="table-responsive">
                  <table className="table table-stretched">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <p className="mb-1 font-weight-medium">NFLX</p><small className="font-weight-medium">Netflix, Inc.</small>
                        </td>
                      ...
                      <tr>
                        <td>
                          <p className="mb-1 font-weight-medium">TSLA</p><small className="font-weight-medium">Tesla, Inc.</small>
                        </td>
                      ...
                      <tr>
                        <td>
                          <p className="mb-1 font-weight-medium">AMZN</p><small className="font-weight-medium">Amazon.com, Inc.</small>
                        </td>

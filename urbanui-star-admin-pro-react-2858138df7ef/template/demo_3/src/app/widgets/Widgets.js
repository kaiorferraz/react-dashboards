                ...
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-medium text-right mb-0">$6,560</h3>
                    </div>
                  </div>
                </div>
            ...
            <div className="card card-statistics">
              <div className="card-body pb-0">
                ...
                <div className="d-flex align-items-center">
                  <h4 className="font-weight-semibold">$65,650</h4>
          ...
          <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
            <div className="card card-statistics">
              <div className="card-body pb-0">
                <p>Unpaid Invoices</p>
                <div className="d-flex align-items-center">
                  <h4 className="font-weight-semibold">$2,542</h4>
                  <h6 className="text-success font-weight-semibold ml-2">+876</h6>
                </div>
          ...
          <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
            <div className="card card-statistics">
              <div className="card-body pb-0">
                <p>Amount Due</p>
                <div className="d-flex align-items-center">
                  <h4 className="font-weight-semibold">$3450</h4>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <p className="mb-2">Unpaid Invoices</p>
                <div className="d-flex align-items-center">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <p className="mb-2">Gross volume</p>
                <div className="d-flex align-items-center">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <p className="mb-2">Average revenue</p>
                <div className="d-flex align-items-center">

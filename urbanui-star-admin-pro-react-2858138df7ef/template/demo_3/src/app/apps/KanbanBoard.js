    ...
    return (
      <div className="col-md-4">
        <div className="board-wrapper p-3">        
          <div className="board-portlet"><h4 className="portlet-heading">{this.props.column.tittle}</h4></div>
        ...
        <div className="d-flex flex-column flex-md-row align-items-center flex-wrap pb-5">
          <h4 className="mb-md-0 mb-4">Design Board</h4>
            <div className="wrapper d-flex align-items-center">
              ...
              <button type="button" className="btn btn-inverse-primary px-5 ml-4"><i className="mdi mdi-lock mr-2"></i>Private</button>
            </div>
          <div className="wrapper ml-md-auto  d-none d-lg-flex flex-column flex-md-row kanban-toolbar ml-md-0 my-2">
            <div className="d-flex">
              <button type="button" className="btn btn-icons btn-inverse-primary d-none d-lg-block">
                <i className="mdi mdi-magnify"></i>
              </button>
              <button type="button" className="btn btn-icons btn-inverse-primary d-none d-lg-block">
                <i className="mdi mdi-filter-outline"></i>
              </button>
              <button type="button" className="btn btn-inverse-primary btn-icons">
            ...
            <div className="d-flex mt-4 mt-md-0">
              ...
              <button type="button" className="btn btn-inverse-primary btn-icons mr-0">

              ...
              <ul className="nav">
                ...
                <li className="nav-item">
                  ...
                  >
                    ...
                    <h6 className="az-iconbar-title">Apps</h6>
                      <Link
                        to="/apps/email"
                        className={
                ...
                <li className="nav-item">
                  ...
                  >
                    ...
                    <Dropdown.Menu className="az-menu-sub">
                      <h6 className="az-iconbar-title">Pages</h6>
                      <Link
                  ...
                  >
                    ...
                    <Dropdown.Menu className="az-menu-sub">
                      <div>
                        <div>
                          <nav className="nav">
                            <h6 className="az-iconbar-title">UI Elements</h6>
                            <Link
                ...
                <li className="nav-item">
                  ...
                  >
                    ...
                    <Dropdown.Menu className="az-menu-sub">
                      <h6 className="az-iconbar-title">Utilities</h6>
                      <Link

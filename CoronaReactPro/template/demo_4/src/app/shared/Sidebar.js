  ...
  render () {
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top text-center">
        ...
        <ul className="nav">
          <li className='nav-item nav-profile'>
            <div className="account-dropdown">
              <div className={ this.state.accountDropdownMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('accountDropdownMenuOpen') } data-toggle="collapse">
                <img className="img-xs rounded-circle" src={require('../../assets/images/faces/face15.jpg')} alt="profile" />
                <p className="mb-0 text-light"><Trans>Stella Johnson</Trans></p>
                <i className="menu-arrow"></i>
              </div>
            </div>
            <Collapse in={ this.state.accountDropdownMenuOpen }>
              <div>
              <ul className="nav flex-column sub-menu pl-0">
                <li className="nav-item">
                  <a className="nav-link pl-5" href="!#">
                ...
                <li className="nav-item">
                  <a className="nav-link pl-5" href="!#">
                    ...
                    <span className="menu-title"><Trans>Inbox</Trans></span>
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link pl-5" href="!#">

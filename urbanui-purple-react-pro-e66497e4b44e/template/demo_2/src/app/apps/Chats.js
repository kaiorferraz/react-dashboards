            ...
            <div className="card chat-app-wrapper">
              <div className="row mx-0">
                <div className={`col-xl-3 col-md-4 chat-list-wrapper px-0 ${menuStatus}`}>
                  ...
                  <div className="sidebar-spacer">
                    <button className="btn btn-block btn-gradient-success py-3" type="button">+ New Chat</button>
                  </div>
                </div>
                ...
                <div className="col-xl-3 d-none d-lg-block px-0 chat-sidebar">
                  ...
                  <div className="px-4">
                    <div className="d-flex pt-4">
                      ...
                      <div className="badge badge-gradient-success mb-auto ml-auto">Online</div>
                    </div>
                    <div className="pt-3">

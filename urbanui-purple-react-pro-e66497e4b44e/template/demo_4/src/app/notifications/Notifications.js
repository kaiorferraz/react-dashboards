                        ...
                        <div className="card px-3">
                            <div className="card-body">
                                ...
                                <div className="template-demo d-flex justify-content-md-between flex-wrap">
                                    <button type="button" className="btn btn-gradient-success btn-fw" onClick={() => cogoToast.success('This is a success message!', this.toastoptions)} >Success</button>
                                    <button type="button" className="btn btn-gradient-info btn-fw" onClick={() => cogoToast.info('This is a success message!', this.toastoptions)} >Info</button>
                                    <button type="button" className="btn btn-gradient-warning btn-fw" onClick={() => cogoToast.warn('This is a success message!', this.toastoptions)} >Warning</button>
                                    <button type="button" className="btn btn-gradient-danger btn-fw" onClick={() => cogoToast.error('This is a success message!', this.toastoptions)} >Error</button>
                                </div>
                            </div>
                        </div>
                    </div>

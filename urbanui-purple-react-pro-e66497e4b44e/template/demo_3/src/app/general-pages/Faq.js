            ...
            <div className="card">
              <div className="card-body">
                <div className="faq-section">
                  <div className="container-fluid bg-gradient-success py-2">
                ...
                <div className="faq-section">
                  <div className="container-fluid bg-gradient-warning py-2">
                ...
                <div className="faq-section">
                  <div className="container-fluid bg-gradient-danger py-2">

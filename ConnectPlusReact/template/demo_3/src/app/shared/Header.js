        ...
        <nav className="navbar top-navbar default-layout-navbar col-lg-12 col-12 p-0 d-flex flex-row">
          <div className="container">
            <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <Link className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/logo-dark.svg')} alt="logo" /></Link>
        ...
        <nav className="bottom-navbar">
          <div className="container">
            <ul className="nav page-navigation">
              ...
              <li className="nav-item">
                <a className="nav-link" href="http://bootstrapdash.com/demo/connect-plus/react/documentation/documentation.html" rel="noopener noreferrer" target="_blank">

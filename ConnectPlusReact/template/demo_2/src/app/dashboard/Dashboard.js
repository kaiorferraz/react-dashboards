      ...
      <div>
        <div>
          <div className="d-sm-flex justify-content-between align-items-start">
            <h2 className="font-weight-bold mb-2"> Overview dashboard </h2>
            <div className="d-sm-flex justify-content-xl-between align-items-center mb-2">
              <div className="btn-group d-none d-xl-flex bg-dark-grey p-3" role="group" aria-label="Basic example">
                ...
                <button type="button" className="btn btn-link py-0 font-weight-medium border-right">1 Month</button>
                      ...
                      <div>
                        <div className="row">
                          <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div className="card">
                              <div className="card-body text-center">
                                <h5 className="mb-2 font-weight-normal">Orders</h5>
                          ...
                          <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div className="card">
                              <div className="card-body text-center">
                                <h5 className="mb-2 font-weight-normal">Unique Visitors</h5>
                          ...
                          <div className="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div className="card">
                              <div className="card-body text-center">
                                <h5 className="mb-2 font-weight-normal">Impressions</h5>
                          ...
                          <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                            <div className="card">
                              <div className="card-body text-center">
                                <h5 className="mb-2 font-weight-normal">Followers</h5>
                                    ...
                                    <div className="pl-0 pl-lg-4 ">
                                      <div className="d-xl-flex justify-content-between align-items-center mb-2">
                                        <div className="d-lg-flex align-items-center mb-2 mb-xl-0">
                                          <h3 className="font-weight-bold mr-2 mb-0">Devices sales</h3>
                                          <h5 className="mb-0">( growth 62% )</h5>
                                        </div>
                                        <div className="d-lg-flex">
                                          <p className="mr-2 mb-0">Timezone:</p>
                                          <p className="font-weight-bold mb-0">GMT-0400 Eastern Delight Time</p>
                                        </div>
                                      </div>
                              ...
                              <div className="card-body recent-activity">
                                ...
                                <div className="d-flex mb-3">
                                  ...
                                  <div className="activity-details">
                                    <h4 className="font-weight-normal">Iva Barber</h4>
                                ...
                                <div className="d-flex mb-3">
                                  ...
                                  <div className="activity-details">
                                    <h4 className="font-weight-normal">Dorothy Romero</h4>
                                    <p className="mb-0">added new task on trello</p>
                                ...
                                <div className="d-flex mb-3">
                                  ...
                                  <div className="activity-details">
                                    <h4 className="font-weight-normal">Ricardo Hawkins</h4>
                                    <p className="mb-0">added new task on trello</p>
                                ...
                                <div className="d-flex">
                                  ...
                                  <div className="activity-details">
                                    <h4 className="font-weight-normal">Noah Montgomery</h4>
                                    <p className="mb-0">added new task on trello</p>
                                  ...
                                  <div className="row">
                                    <div className="col-sm-6 mb-4 mb-lg-0">
                                      <div className="d-lg-flex justify-content-between align-items-center mb-1">
                                        <div className="text-small">Available :</div>

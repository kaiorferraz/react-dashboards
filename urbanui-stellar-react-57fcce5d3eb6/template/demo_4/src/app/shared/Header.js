                ...
                <li className="nav-item message-dropdown">
                  <Dropdown alignRight>
                    ...
                    <Dropdown.Menu className="preview-list navbar-dropdown">
                      <p className="px-2 py-3 mb-0 d-flex justify-content-between">
                        <Trans>
                          <p class="mb-0 font-weight-medium mr-1">
                    ...
                    <Dropdown.Menu className="navbar-dropdown">
                      ...
                      >
                        <div class="dropdown-header text-center">
                          ...
                          <p class="font-weight-light text-muted mb-0">
                            <Trans>kleinhenry@gmail.com</Trans>
                          </p>
                        </div>
                      </Dropdown.Item>
                      <Dropdown.Item
                      ...
                      >
                        <p class="preview-item d-flex align-items-center m-0">
                          <i class="dropdown-item-icon icon-user text-primary mr-2"></i>{" "}
                      ...
                      >
                        <p class="preview-item d-flex align-items-center m-0">
                          <i class="dropdown-item-icon icon-speech text-primary mr-2"></i>{" "}
                      ...
                      >
                        <p class="preview-item d-flex align-items-center m-0">
                          <i class="dropdown-item-icon icon-energy text-primary mr-2"></i>{" "}

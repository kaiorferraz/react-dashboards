        ...
        <nav className="navbar top-navbar default-layout-navbar col-lg-12 col-12 p-0 d-flex flex-row">
          <div className="container">
            <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <Link className="navbar-brand brand-logo" to="/"><img src={require('../../assets/images/logo-light.svg')} alt="logo" /></Link>
                ...
                <li className="nav-item message-dropdown">
                  <Dropdown alignRight>
                    ...
                    <Dropdown.Menu className="preview-list navbar-dropdown">
                      <p className="px-2 py-3 mb-0 d-flex justify-content-between"><Trans>
                        <p class="mb-0 font-weight-medium mr-1">You have 7 unread mails </p>
